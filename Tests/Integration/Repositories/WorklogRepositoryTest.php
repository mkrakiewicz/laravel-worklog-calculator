...
class worklogRepositoryTest extends TestCase
{
    ...
    public function testCreateworklog()
    {
        ...
        $this->assertNotNull(worklog::find($createdworklog['id']), 'worklog with given id must be in DB');
    ...
    public function testDeleteworklog()
    {
        ...
        $this->assertNull(worklog::find($worklog->id), 'worklog should not exist in DB');
    }
}
